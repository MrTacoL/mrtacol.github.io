(() => {
  ...
  css.textContent = `
    .sound-panel.player-loaded,.sound-panel.player-on{top:1rem!important;left:1rem!important;width:min(17rem,90vw)!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important;backdrop-filter:none!important;display:block!important}
    ...
    @media(max-width:650px){
      .sound-panel.player-loaded,.sound-panel.player-on{left:50%!important;top:auto!important;bottom:5.4rem!important;transform:translateX(-50%)!important;width:min(16.8rem,90vw)!important}
      .sound-panel.player-open{width:min(21rem,92vw)!important}
      .sound-panel .music-console{padding:.62rem!important;border-radius:1.25rem!important}
      .sound-panel .music-topline{grid-template-columns:3.5rem minmax(0,1fr)!important}
      .sound-panel .music-disc{width:3.5rem!important;height:3.5rem!important}
      .sound-panel .music-now-title{font-size:.72rem!important}
      .sound-panel.player-open .music-topline{grid-template-columns:3.5rem minmax(0,1fr)!important}
      .sound-panel.player-open .music-volume{grid-column:1/-1;margin:.45rem 0 0!important}
      .sound-panel.player-open .music-controls{grid-template-columns:repeat(3,1fr)!important}
      .sound-panel.player-open .music-mode{font-size:.68rem!important}
      .sound-panel.player-open .music-picker{display:block!important;height:2.2rem!important;font-size:.74rem!important}
      body.music-mode-page .stage,body.music-mode-page .live-widgets,body.music-mode-page .mobile-live-toggle,body.music-mode-page .projects-modal,body.music-mode-page .activity-card,body.music-mode-page .socials,body.music-mode-page .action-row{display:none!important}
      body.music-mode-page .sound-panel{top:0!important;left:0!important;right:0!important;bottom:0!important;transform:none!important;width:100vw!important;max-width:none!important;height:100svh!important;padding:1rem!important;display:grid!important;place-items:center!important;background:rgba(0,0,0,.12)!important;z-index:80!important}
      body.music-mode-page .sound-stack{width:min(21rem,92vw)!important}
      body.music-mode-page .music-console{padding:.9rem!important;border-radius:1.45rem!important}
      body.music-mode-page .music-mode-toggle{margin:.6rem 0!important}
      body.music-mode-page .music-picker{display:block!important}
      body.music-mode-page .music-bottom{display:flex!important}
      body.music-mode-page .live-widgets.mobile-open{padding-bottom:0!important}
    }
  `;
  ...
  function applyPlayerTheme(){
    ...
    if(!document.querySelector('.music-mode-toggle')){
      ...
      btn.addEventListener('click',()=>{
        const open=!soundPanel.classList.contains('player-open');
        soundPanel.classList.toggle('player-open',open);
        document.body.classList.toggle('music-mode-page',open && window.matchMedia('(max-width: 650px)').matches);
